...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_ROOT}/SensorsFocus/SensorsFocus/SensorsFocus.bundle"
  ...
  install_resource "${PODS_ROOT}/YJShareSDK/YJShareSDK/QQSDK/TencentOpenApi_IOS_Bundle.bundle"
  install_resource "${PODS_ROOT}/YJShareSDK/YJShareSDK/libWeiboSDK/WeiboSDK.bundle"
fi
