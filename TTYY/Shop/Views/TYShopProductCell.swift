...
class TYShopProductCell: UITableViewCell {
    ...
    func updateCell(_ model: TYShopProductModel, bottomBtnState: Bool) {
        ...
        att.addAttributes([.strikethroughStyle: NSUnderlineStyle.single.rawValue], range: NSRange(location: priceStr.count, length: originalpriceStr.count))
...
private extension TYShopProductCell {
    func createSubviews() {
